...
<body class="bg-background text-gray-900 font-sans">
    ...
    <nav class="bg-primary p-4 shadow-lg">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div>
                ...
                <a href="catalogo.jsp" class="text-white mx-3 hover:text-secondary">Catálogo</a>
    ...
    <section class="container mx-auto py-10">
        ...
        <div class="flex justify-center space-x-6 overflow-x-auto mb-8 px-4 py-2">
            <button onclick="filtrarCategoria('Todos')" class="text-center focus:outline-none">
                <img src="https://via.placeholder.com/150" alt="Todos"
                     class="w-32 h-32 rounded-full mb-2 shadow-lg transition-transform transform hover:scale-110">
                <p class="text-gray-700 font-semibold">Todos</p>
            </button>
            <c:forEach var="categoria" items="${categorias}">
                <button onclick="filtrarCategoria('${categoria.nombre}')" class="text-center focus:outline-none">
                    <img src="https://via.placeholder.com/150" alt="${categoria.nombre}"
                         class="w-32 h-32 rounded-full mb-2 shadow-lg transition-transform transform hover:scale-110">
                    <p class="text-gray-700 font-semibold">${categoria.nombre}</p>
                </button>
            </c:forEach>
        </div>
    </section>
            ...
            <c:forEach var="producto" items="${productos}">
                <div class="producto-card ${producto.categoria.nombre} bg-white border rounded-lg overflow-hidden shadow-lg transition-transform transform duration-300 hover:scale-105">
                    ...
                    <div class="p-4">
                        ...
                        <button
                            class="w-full bg-primary hover:bg-hoverAccent text-white py-2 rounded-md font-medium shadow-lg transform transition-transform hover:scale-105 duration-300">Añadir
                            al carrito</button>
                    </div>
                </div>
            </c:forEach>
    ...
    <!-- JavaScript para Filtrar y Ordenar Productos -->
    <script>
        ...
        function ordenarProductos() {
            ...
            productos.sort((a, b) => {
                ...
                return 0; // Para "Recomendados" u orden por defecto
            });
